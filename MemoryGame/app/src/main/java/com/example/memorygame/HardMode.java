...
public class HardMode extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        Button button = (Button) findViewById(R.id.returnHomeH);
        ...
        buttonList = new ArrayList<Button>(Arrays.asList(findViewById(R.id.button6), findViewById(R.id.button5), findViewById(R.id.button4),
                ...
                findViewById(R.id.button10), findViewById(R.id.button15), findViewById(R.id.button16), findViewById(R.id.button17), findViewById(R.id.button20),
                findViewById(R.id.button18), findViewById(R.id.button19)));
    ...
    private void onClick(View view, ArrayList<Integer> result){
        ...
        moves++;
        moveTV= (TextView) findViewById(R.id.moveH);
        moveTV.setText("Moves: " + moves);

        if(checkAllFaceUp()){
            bestMoveTV = (TextView) findViewById(R.id.bestMoveH);
            SharedPreferences prefs = this.getSharedPreferences("myPrefsKey", Context.MODE_PRIVATE);
            bestMove = prefs.getInt("key2", 0);
            if(bestMove == 0 || moves <= bestMove ){
                bestMove = moves;
                SharedPreferences.Editor edit = prefs.edit();
                edit.putInt("key2", moves);
                edit.commit();
            }
            ...
            final Runnable runnable = new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(HardMode.this, Main.class);
                    startActivity(intent);
                }
